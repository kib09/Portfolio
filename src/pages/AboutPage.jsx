  ...
  return (
    <div className=" text-white min-h-pull pt-20">
      ...
      <section>
        ...
        <div className="flex items-center justify-center text-center  bg-gradient-to-b ">
        ...
        <div className="flex flex-col justify-center py-16 max-w-4xl mx-auto gap-5 md:flex-row">
          {/* 반응형 이미지 컨테이너 - 모바일에서는 작게, 데스크톱에서는 크게 */}
          <div className="w-32 h-34 sm:w-34 sm:h-36 md:w-36 md:h-38 rounded-3xl overflow-hidden border-2 border-yellow-900 object-cover mx-auto md:mx-0">
            <img 
              src={profile} 
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className=" flex flex-col md:items-center md:flex-row">
              ...
              <div className="flex flex-row gap-2">
                <p className="text-3xl flex flex-row">(In-Bae Kim)</p>
              </div>
            </div>
            <div>
              <p>1999 .06 .15</p>
            ...
            <FadeInItem index={2}>
              <div className="flex flex-col gap-4">
                ...
                <p className="ml-2">
                  ...
                  즐거움입니다.
                  <br />
                  배우는것에 대한 두려움이 없고 차근차근 배워 나가는것을
                  좋아하며
                  <br />
                  <span className="font-bold">
                    꾸준히 기록하고 회고하는 습관
