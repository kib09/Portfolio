function ProjectCard({ title, short, image, onClickDetail }) {
  return (
    <div
      className="relative bg-neutral-200 dark:bg-neutral-600 rounded-xl shadow-md overflow-hidden group hover:shadow-xl transition cursor-pointer"
    ...
    >
      ...
      <div className="absolute inset-0 bg-opacity-40 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
        <div className=" px-4 py-2 rounded font-semibold text-yellow-500">
          자세히 보기
        </div>
      </div>
    </div>
