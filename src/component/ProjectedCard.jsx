function ProjectCard({ title, short, image, onClickDetail }) {
  return (
    <div className="relative bg-neutral-200 dark:bg-neutral-600 rounded-xl shadow-md overflow-hidden group hover:shadow-xl transition">
      ...
      <div className="absolute inset-0 bg-opacity-40 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
        <button
          ...
          className="bg-yellow-400 px-4 py-2 rounded font-semibold hover:bg-yellow-500 cursor-pointer"
        >
          자세히 보기
        </button>
      </div>
