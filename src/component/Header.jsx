...
function Header() {
  ...
  return (
    <>
      <header className="p-4 bg-neutral-600 shadow-xl text-white flex justify-between items-center fixed w-full z-50">
        {/* 로고 */}
        <h1 className="text-xl font-bold hover:text-yellow-400  transition-all duration-300 ease-in-out ">
          Inveloper
        </h1>
